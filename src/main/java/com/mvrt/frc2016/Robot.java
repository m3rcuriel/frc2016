...
/**
 * Base class for the robot. This is the class which will run when the code is initialized on the RoboRIO. Many optional
 * methods can be overridden in addition to the periodic methods.
 *
 * @author Lee Mracek
 */
