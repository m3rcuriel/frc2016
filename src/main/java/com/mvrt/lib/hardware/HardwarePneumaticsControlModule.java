...
import com.mvrt.lib.components.CurrentSensor;
import com.mvrt.lib.components.PneumaticsControlModule;
import com.mvrt.lib.components.Relay;
import com.mvrt.lib.components.Switch;
import edu.wpi.first.wpilibj.Compressor;

/**
 * Hardware representation of a PCM which we can use to obtain current, state, etc.
 *
...
public class HardwarePneumaticsControlModule implements PneumaticsControlModule {
  ...
  /**
   * Retrieve a {@link com.mvrt.lib.components.PneumaticsControlModule.Faults} object
